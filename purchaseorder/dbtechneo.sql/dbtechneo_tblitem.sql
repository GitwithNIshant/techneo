...
CREATE TABLE `tblitem` (
  ...
  CONSTRAINT `tblitem_ibfk_1` FOREIGN KEY (`BookName`) REFERENCES `tblbook` (`bookId`),
  CONSTRAINT `tblitem_ibfk_2` FOREIGN KEY (`FacultyName`) REFERENCES `tblfaculty` (`facultyID`)
...
INSERT INTO `tblitem` VALUES (1,1,1,1);
...
-- Dump completed on 2023-03-08 17:29:15
