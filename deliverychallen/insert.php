...
if (isset($_POST['insertdata'])) {
     ...
     // $query2    = "select max(Dcid) as maxpid from tbldeliverychallan;";
     echo $query1;
     // echo "$P_id ="  .$P_id;
     ...
     //           $query3 = "insert into tbldeliveritem (bookId,facultyID,deliveryquentity,Dcid) values ($bookId,$facultyID,$purchasequentity,$maxpid);";
     //           // echo $queryt."</br>";
